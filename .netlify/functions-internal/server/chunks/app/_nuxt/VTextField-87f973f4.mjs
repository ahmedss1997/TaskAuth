import { toRef as toRef$1, createVNode, provide, inject, computed, watch, reactive, mergeProps, toRefs, ref, Text, watchEffect, Transition, withDirectives, resolveDirective, h, shallowRef, nextTick, Fragment, Teleport, vShow, cloneVNode, capitalize, camelize, isRef, unref, resolveDynamicComponent, TransitionGroup, effectScope, onScopeDispose, toRaw, readonly, warn, customRef, getCurrentScope } from 'vue';
import { p as propsFactory, m as makeComponentProps, j as makeThemeProps, g as genericComponent, l as provideTheme, d as provideDefaults, e as useRender, K as getCurrentInstance, L as getUid, a as useProxiedModel, y as deepEqual, I as IconValue, P as useIcon, Q as flattenFragments, q as convertToUnit, v as useResizeObserver, n as useRtl, S as SUPPORTS_INTERSECTION, _ as useToggleScope, $ as omit, X as refElement, E as EventProp, C as getCurrentInstanceName, M as wrapInArray, f as filterInputAttrs, N as findChildrenWithProvide, O as consoleWarn, D as destructComputed, z as includes, R as hasEvent, Y as IN_BROWSER, b as useLocale, A as isOn, a0 as pick, a1 as callEvent, B as eventName, F as isCssColor, G as isParsableColor, H as parseColor, J as getForeground, Z as matchesSelector, T as isObject, V as consoleError, x as clamp, U as keyCodes, W as defer } from '../server.mjs';
...
const validation = {
  textRules: [
    ...
    (value) => value && value.trim().length >= minText || "The input must contain at least " + minText + " characters!",
    (value) => value && value.trim().length <= maxText || "The input can not exceed " + maxText + " characters!",
    (value) => {
  ...
  emailRules: [
    ...
    (value) => {
      ...
      return value ? pattern.test(value.trim()) || "Invalid email." : "Required!";
    }
  ],
  passowrdRules: [
    (value) => !!value || "Required!",
    (value) => value && value.trim().length <= maxText || "The input can not exceed " + maxText + " characters!",
    (value) => value && value.trim().length >= passwordMin || "Password must be of at least " + passwordMin + " characters/numbers!"
  ]
};
function confirmPassword(password) {
  return [
    (value) => !!value || "Required!",
    (value) => value && value.length >= 8 || "Password must be of at least " + passwordMin + " characters/numbers!",
    (value) => value === password || "Passwords are not matched!"
  ];
}
const validation$1 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  confirmPassword,
  validation
});
...
function useGroupItem(props, injectKey) {
  ...
  const value = toRef$1(props, "value");
...
function useGroup(props, injectKey) {
  ...
  const state = {
    ...
    selected,
    select,
    disabled: toRef$1(props, "disabled"),
...
const VIcon = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const {
      textColorClasses,
      textColorStyles
    } = useTextColor(toRef$1(props, "color"));
    useRender(() => {
      var _a, _b;
...
const VProgressCircular = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    } = useTextColor(toRef$1(props, "bgColor"));
    const {
      intersectionRef,
      isIntersecting
...
const VImg = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const {
      backgroundColorClasses,
      backgroundColorStyles
    } = useBackgroundColor(toRef$1(props, "color"));
    const {
      roundedClasses
    } = useRounded(props);
...
function createForm(props) {
  ...
  provide(FormKey, {
    ...
    isValid: model,
    items,
    validateOn: toRef$1(props, "validateOn")
  });
  return {
    errors,
    isDisabled,
...
const VOverlay = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const {
      ...
      localTop,
      stackStyles
    } = useStack(isActive, toRef$1(props, "zIndex"), props._disableGlobalStack);
    const {
      activatorEl,
      activatorRef,
      target,
...
const VField = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const {
      backgroundColorClasses,
      backgroundColorStyles
    } = useBackgroundColor(toRef$1(props, "bgColor"));
    const {
      textColorClasses,
      textColorStyles
...
export { VFadeTransition as A, makeVariantProps as B, makeBorderProps as C, makeDensityProps as D, makeElevationProps as E, makeRoundedProps as F, makeRouterProps as G, makeSizeProps as H, useBorder as I, useVariant as J, useDensity as K, useElevation as L, MaybeTransition as M, useRounded as N, useSize as O, useLink as P, genOverlays as Q, Ripple as R, VExpandXTransition as S, VDefaultsProvider as T, VCard as V, VSheet as a, VCardText as b, VForm as c, VTextField as d, VBtn as e, VCardActions as f, VSnackbar as g, VIcon as h, makeFocusProps as i, makeVFieldProps as j, useDimension as k, useFocus as l, makeDimensionProps as m, VField as n, VOverlay as o, VProgressCircular as p, makeTagProps as q, useGroup as r, makeGroupItemProps as s, makeLazyProps as t, useFetch as u, validation$1 as v, useGroupItem as w, useLazy as x, VAvatar as y, makeGroupProps as z };
//# sourceMappingURL=VTextField-87f973f4.mjs.map
