import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, version as version$1, unref, inject as inject$1, Fragment, reactive, computed, watchEffect, toRefs, capitalize, warn, ref, provide, defineComponent as defineComponent$1, createVNode, mergeProps, watch, onScopeDispose, toRaw, readonly, useSSRContext, effectScope, shallowRef, withCtx, createApp, h, Suspense, nextTick, Transition, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, toRef, shallowReactive, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive } from 'vue';
...
import { useRoute as useRoute$1, useRouter as useRouter$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/login-85a3e5d5.mjs').then((m) => m.default || m)
  },
  {
    name: "register",
    path: "/register",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/register-8c7327bd.mjs').then((m) => m.default || m)
  },
  {
    name: "resetPassword",
    path: "/resetPassword",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/resetPassword-1709bf42.mjs').then((m) => m.default || m)
  }
];
...
function vuetifyConfiguration() {
  const options = JSON.parse('{"theme":{"defaultTheme":"simple","themes":{"simple":{"dark":false,"colors":{"primary":"#1976D2","secondary":"#4E147C","subcolor":"#FB3681","accent":"#82B1FF","error":"#FF5252","info":"#2196F3","success":"#4CAF50","warning":"#FFC107"}},"simpleDark":{"dark":true,"colors":{}}}},"ssr":true}');
  return options;
}
...
const vuetify_OdPEdOST6f = /* @__PURE__ */ defineNuxtPlugin({
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-84b41888.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-ba0c7f6d.mjs').then((r) => r.default || r));
...
export { omit as $, isOn as A, eventName as B, getCurrentInstanceName as C, destructComputed as D, EventProp as E, isCssColor as F, isParsableColor as G, parseColor as H, IconValue as I, getForeground as J, getCurrentInstance as K, getUid as L, wrapInArray as M, findChildrenWithProvide as N, consoleWarn as O, useIcon as P, flattenFragments as Q, hasEvent as R, SUPPORTS_INTERSECTION as S, isObject as T, keyCodes as U, consoleError as V, defer as W, refElement as X, IN_BROWSER as Y, matchesSelector as Z, useToggleScope as _, useProxiedModel as a, pick as a0, callEvent as a1, useRouter as a2, nuxtLinkDefaults as a3, navigateTo as a4, useLocale as b, createError as c, provideDefaults as d, entry$1 as default, useRender as e, filterInputAttrs as f, genericComponent as g, focusChild as h, injectHead as i, makeThemeProps as j, keys as k, provideTheme as l, makeComponentProps as m, useRtl as n, only as o, propsFactory as p, convertToUnit as q, resolveUnrefHeadInput as r, makeDisplayProps as s, useDisplay as t, useNuxtApp as u, useResizeObserver as v, focusableChildren as w, clamp as x, deepEqual as y, includes as z };
