...
const inlineAppConfig = {
  "nuxt": {
    "buildId": "ea588f4e-95f7-47fa-849c-1750c8adb83c"
  }
};
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"D:\\Work\\VueProjects\\TaskAuth\\.data\\kv"}));
...
const _lazy_F6Rv7j = () => import('../handlers/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_F6Rv7j, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_F6Rv7j, lazy: true, middleware: false, method: undefined }
];
